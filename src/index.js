...
const {genLocationmsg, genmsg} = require('./utils/message')
...
io.on('connection', (socket) => {
    ...
    socket.on('location', (coords, callback) => {
        const user = getUser(socket.id)
        io.to(user.room).emit('locationmessage', genLocationmsg(user.username,`https://google.com/maps?q=${coords.latitude},${coords.longitude}`))
        callback()
    })
